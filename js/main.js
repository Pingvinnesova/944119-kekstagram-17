...
//   effectLevelPin.style.left = (startCoordsNew.x * 100) / effectLevelLine.offsetWidth + '%';
//   effectLevelDepth.style.width = effectLevelPin.style.left;
//   effectLevelValue.value = effectLevelPin.style.left;
...
//     {
//       key: 'chrome',
//       style: 'filter: grayscale(' + ((startCoordsNew.x * 100) / effectLevelLine.offsetWidth / 100) + ')'
//     },

//     {
//       key: 'sepia',
//       style: 'filter: sepia(' + ((startCoordsNew.x * 100) / effectLevelLine.offsetWidth / 100) + ')'
//     },

//     {
//       key: 'marvin',
//       style: 'filter: invert(' + (startCoordsNew.x * 100) / effectLevelLine.offsetWidth + '%)'
//     },

//     {
//       key: 'phobos',
//       style: 'filter: blur(' + (3 * ((startCoordsNew.x * 100) / effectLevelLine.offsetWidth / 100)) + 'px)'
//     },

//     {
//       key: 'heat',
//       style: 'filter: brightness(' + ((2 * ((startCoordsNew.x * 100) / effectLevelLine.offsetWidth / 100)) + 1) + ')'
//     }
//   ];
